...
Điểm trên phản ánh toàn bộ sản phẩm hoàn chỉnh: 135 authored cases, 91 Newman mappings, `summary.json` (90 assertions; 52 ok; 38 not ok), 12 bug records, 2 public CI runs và video Agent Skill demo.
...
├── .agents/skills/api-test-generator/
│   ├── SKILL.md
│   └── resources/ (diagram.mermaid, chart.png, pseudocode.md, skill-demo-notes.md)
