...
| Bug ID | API Endpoint | Tiêu đề lỗi (Defect Title) | Phân loại (Type) | Mức độ (Severity) | Vị trí mã nguồn SUT | GitHub Issue |
|:---:|---|---|---|:---:|---|:---:|
| **`BUG-FR02-01`** | `POST /api/login` | Bộ đếm `login_attempts` cộng 2 mỗi lần sai thay vì cộng 1 | Business Logic | **High** | `server.js:L54` | [Issue #5](https://github.com/HCMUS-software-testing/HW06/issues/5) |
| **`BUG-FR02-02`** | `POST /api/login` | Thời gian khóa tài khoản là 180s (3 phút) thay vì 30s | Business Logic | **Medium** | `server.js:L57` | [Issue #6](https://github.com/HCMUS-software-testing/HW06/issues/6) |
| **`BUG-FR02-03`** | `POST /api/login` | Thiếu validation regex định dạng Email, trả về 401 thay vì 400 | Data Validation | **Low** | `server.js:L33` | [Issue #7](https://github.com/HCMUS-software-testing/HW06/issues/7) |
| **`BUG-FR02-04`** | `POST /api/login` | **Lỗ hổng bảo mật:** Response đăng nhập trả về nguyên vẹn trường `password` | Security (SEC-01) | **Critical** | `server.js:L52` | [Issue #8](https://github.com/HCMUS-software-testing/HW06/issues/8) |
| **`BUG-FR07-01`** | `POST /api/cart` | Backend không kiểm tra số lượng âm hoặc bằng 0 (`quantity <= 0`) | Data Validation | **High** | `server.js:L290-295` | [Issue #9](https://github.com/HCMUS-software-testing/HW06/issues/9) |
| **`BUG-FR07-02`** | `POST /api/cart` | Thêm trùng sản phẩm bị thêm thành dòng mới thay vì cộng dồn số lượng | Business Logic | **Medium** | `server.js:L293` | [Issue #10](https://github.com/HCMUS-software-testing/HW06/issues/10) |
| **`BUG-FR07-03`** | `/api/cart` | Thiếu hoàn toàn API Cập nhật số lượng (`PUT`) và Xóa item (`DELETE`) | Missing Feature | **Critical** | `server.js:L280-296` | [Issue #11](https://github.com/HCMUS-software-testing/HW06/issues/11) |
| **`BUG-FR07-04`** | `/api/cart` | Giỏ hàng lưu in-memory `userCarts`, mất sạch dữ liệu khi server restart | Architecture | **High** | `server.js:L284-295` | [Issue #12](https://github.com/HCMUS-software-testing/HW06/issues/12) |
| **`BUG-FR15-01`** | `POST/PUT/DELETE /api/products` | **Lỗ hổng bảo mật:** Thiếu middleware xác thực Admin (`authenticateToken`) | Security (SEC-03) | **Critical** | `server.js:L167,179,191` | [Issue #13](https://github.com/HCMUS-software-testing/HW06/issues/13) |
| **`BUG-FR15-02`** | `GET /api/products/:id` | Ép kiểu `price` sang String ở các sản phẩm có ID chẵn | Data Type Bug | **Medium** | `server.js:L162` | [Issue #14](https://github.com/HCMUS-software-testing/HW06/issues/14) |
| **`BUG-FR15-03`** | `POST /api/products` | Cho phép tạo sản phẩm với giá âm (`price < 0`) và tên rỗng | Data Validation | **High** | `server.js:L167-176` | [Issue #15](https://github.com/HCMUS-software-testing/HW06/issues/15) |
| **`BUG-FR15-04`** | `POST /api/admin/import-products` | Thiếu kiểm tra vai trò `admin`, user thường vẫn import được sản phẩm | Security (SEC-03) | **High** | `server.js:L199` | [Issue #16](https://github.com/HCMUS-software-testing/HW06/issues/16) |
...
![GitHub Issue #5](screenshots/github-issues/issue-1.png)
- **Mã lỗi:** `BUG-FR02-01`
- **Liên kết GitHub Issue:** [https://github.com/HCMUS-software-testing/HW06/issues/5](https://github.com/HCMUS-software-testing/HW06/issues/5)
...
![GitHub Issue #6](screenshots/github-issues/issue-2.png)
- **Mã lỗi:** `BUG-FR02-02`
- **Liên kết GitHub Issue:** [https://github.com/HCMUS-software-testing/HW06/issues/6](https://github.com/HCMUS-software-testing/HW06/issues/6)
- **API Endpoint:** `POST /api/login`
...
![GitHub Issue #7](screenshots/github-issues/issue-3.png)
- **Mã lỗi:** `BUG-FR02-03`
- **Liên kết GitHub Issue:** [https://github.com/HCMUS-software-testing/HW06/issues/7](https://github.com/HCMUS-software-testing/HW06/issues/7)
- **API Endpoint:** `POST /api/login`
...
- **Phân tích nguyên nhân gốc:** Tại `server.js:L33-40`, route handler không sử dụng regex kiểm tra email trước khi gọi `db.get`.

---

### BUG-FR02-04: Lỗ hổng bảo mật nghiêm trọng — Rò rỉ mật khẩu trong Response Login

![GitHub Issue #8](screenshots/github-issues/issue-4.png)
- **Mã lỗi:** `BUG-FR02-04`
- **Liên kết GitHub Issue:** [https://github.com/HCMUS-software-testing/HW06/issues/8](https://github.com/HCMUS-software-testing/HW06/issues/8)
- **API Endpoint:** `POST /api/login`
...
![GitHub Issue #9](screenshots/github-issues/issue-5.png)
- **Mã lỗi:** `BUG-FR07-01`
- **Liên kết GitHub Issue:** [https://github.com/HCMUS-software-testing/HW06/issues/9](https://github.com/HCMUS-software-testing/HW06/issues/9)
...
![GitHub Issue #10](screenshots/github-issues/issue-6.png)
- **Mã lỗi:** `BUG-FR07-02`
- **Liên kết GitHub Issue:** [https://github.com/HCMUS-software-testing/HW06/issues/10](https://github.com/HCMUS-software-testing/HW06/issues/10)
- **API Endpoint:** `POST /api/cart`
- **Mức độ nghiêm trọng:** **Medium**
...
![GitHub Issue #11](screenshots/github-issues/issue-7.png)
- **Mã lỗi:** `BUG-FR07-03`
- **Liên kết GitHub Issue:** [https://github.com/HCMUS-software-testing/HW06/issues/11](https://github.com/HCMUS-software-testing/HW06/issues/11)
...
![GitHub Issue #12](screenshots/github-issues/issue-8.png)
- **Mã lỗi:** `BUG-FR07-04`
- **Liên kết GitHub Issue:** [https://github.com/HCMUS-software-testing/HW06/issues/12](https://github.com/HCMUS-software-testing/HW06/issues/12)
...
![GitHub Issue #13](screenshots/github-issues/issue-9.png)
- **Mã lỗi:** `BUG-FR15-01`
- **Liên kết GitHub Issue:** [https://github.com/HCMUS-software-testing/HW06/issues/13](https://github.com/HCMUS-software-testing/HW06/issues/13)
...
![GitHub Issue #14](screenshots/github-issues/issue-10.png)
- **Mã lỗi:** `BUG-FR15-02`
- **Liên kết GitHub Issue:** [https://github.com/HCMUS-software-testing/HW06/issues/14](https://github.com/HCMUS-software-testing/HW06/issues/14)
- **API Endpoint:** `GET /api/products/:id`
- **Mức độ nghiêm trọng:** **Medium** (Lỗi vi phạm hợp đồng dữ liệu API Schema Contract)
- **Mô tả:** Khi gọi API lấy chi tiết sản phẩm, nếu sản phẩm có `id` là số chẵn (ví dụ ID 2, ID 4, ID 6), server cố tình ép kiểu trường `price` sang kiểu String (`"28000000"` thay vì `28000000`).
- **Phân tích nguyên nhân gốc:**
  Tại `server.js:L162`:
  ```javascript
...
![GitHub Issue #15](screenshots/github-issues/issue-11.png)
- **Mã lỗi:** `BUG-FR15-03`
- **Liên kết GitHub Issue:** [https://github.com/HCMUS-software-testing/HW06/issues/15](https://github.com/HCMUS-software-testing/HW06/issues/15)
...
![GitHub Issue #16](screenshots/github-issues/issue-12.png)
- **Mã lỗi:** `BUG-FR15-04`
- **Liên kết GitHub Issue:** [https://github.com/HCMUS-software-testing/HW06/issues/16](https://github.com/HCMUS-software-testing/HW06/issues/16)
