...
- **SKILL.md:** `src/.agents/skills/api-test-generator/SKILL.md`
- **Resources:** `src/.agents/skills/api-test-generator/resources/` (pseudocode, diagram.mermaid, chart.png)
- **Examples:** `src/.agents/skills/api-test-generator/examples/` (FR-05 sample output)
