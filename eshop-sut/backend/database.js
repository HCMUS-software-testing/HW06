...
function initDatabase() {
    db.serialize(() => {
        ...
        // Seed Users with Dedicated Test Fixtures
        ...
        insertUser.run('Lockout Target User', 'lockout_target@eshop.com', 'Lockout123!', 'user');
        insertUser.run('Cart Test User', 'cart_user@eshop.com', 'CartPass123!', 'user');
        insertUser.run('Profile Test User', 'profile_user@eshop.com', 'Profile123!', 'user');
        // Member 3 test fixtures (23127185): dedicated users for registration and coupon suites
        insertUser.run('Coupon Test User', 'coupon_user@eshop.com', 'CouponPass123!', 'user');
        insertUser.run('Register Test User', 'register_user@eshop.com', 'Register123!', 'user');
        insertUser.finalize();
